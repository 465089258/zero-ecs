 ...
 */
export const ChildOf = defineQueryProjection<ComponentTag>(ChildOfStorage, "ChildOf");
 ...
 */
export const ParentOf = defineQueryProjection<ComponentTag>(ParentOfStorage, "ParentOf");
