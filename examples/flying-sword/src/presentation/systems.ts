...
function renderFlyingSwordDemo(
    ...
    fireBursts: Parameters<DemoRenderService["render"]>[8],
    swordBuilds: Parameters<DemoRenderService["render"]>[9],
    groups: Parameters<DemoRenderService["render"]>[10],
    swords: Parameters<DemoRenderService["render"]>[11],
): void {
    renderer.render(
        frame.interpolation,
        scene,
