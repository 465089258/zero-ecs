...
export class DamageRequestType implements Component<DamageRequest> {
    readonly [DamageRequest.source] = Types.U32;
    readonly [DamageRequest.target] = Types.U32;
...
export class DamageResultType implements Component<DamageResult> {
    readonly [DamageResult.source] = Types.U32;
    readonly [DamageResult.target] = Types.U32;
